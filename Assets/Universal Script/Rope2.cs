    ...
    void checkWeight()
    {
        if(Rope1.r.weight < weight)
        {
            if(Rope1.r.weight == 0)
            {
                ...
                if (GameManager.instane.D2 < 3f)
                {
                    GameManager.instane.anime2.SetFloat("speed", 5.0f);
                }
                else
                {
                    GameManager.instane.anime2.SetFloat("speed", 3.0f);
                }
            ...
            if(Rope1.r.weight != 0)
            {
                ...
                if (!GameManager.instane.fallDown2)
                {
                    GameManager.instane.Face_2.SetBool("Scary", true);
                    GameManager.instane.anime2.SetBool("Hang", true);
                }
        ...
        if (Rope1.r.weight > weight)
        {
            if (weight == 0)
            {
                ...
                GameManager.instane.anime2.SetFloat("speed", 1.0f);
                WheelRotator.wr.rotator(1,50);
            }
            if (weight != 0)
            {
                ...
                if (!GameManager.instane.fallDown2)
                {
                    GameManager.instane.Face_2.SetBool("Scary", false);
